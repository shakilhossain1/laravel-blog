...
/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./search */ "./resources/js/search.js");


window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_0__.default;
alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.data('search', _search__WEBPACK_IMPORTED_MODULE_1__.default);
...
function search() {
  return {
    ...
    run: debounce(function () {
      ...
      this.loading = true;
      var host = "https://".concat(window.algoliaAppId, "-dsn.algolia.net");
      var url = "/search?q=".concat(encodeURIComponent(this.query));
      fetch(url, {
        headers: {
